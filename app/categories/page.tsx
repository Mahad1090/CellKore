										...
										{hasCustomCover ? (
											<>
												...
												<div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent px-3 py-3">
													<h3 className="font-semibold text-white text-xs sm:text-sm uppercase tracking-wider">
														{category.name}
													</h3>
												</div>
											</>
											...
											<>
												...
												<h3 className="font-semibold text-foreground text-xs sm:text-sm uppercase tracking-wider group-hover:text-primary transition-colors">
													{category.name}
												</h3>
											</>
										)}
