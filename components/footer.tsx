        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/products" className="hover:text-indigo-300 transition-colors">Products</Link></li>
              <li><Link href="/marketplace" className="hover:text-indigo-300 transition-colors">Marketplace</Link></li>
              <li><Link href="/wholesale" className="hover:text-indigo-300 transition-colors">Wholesale</Link></li>
            </ul>
          </div>
