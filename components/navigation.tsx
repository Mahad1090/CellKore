						...
						<div className="flex items-center justify-end w-auto md:w-1/3 space-x-0.5 sm:space-x-2 lg:space-x-3 z-10">
							...
							<div className="relative animate-fade-in" ref={profileMenuRef}>
								<button
									...
									className="p-1.5 sm:p-2 sm:px-4 sm:py-2 hover:bg-muted sm:border sm:border-border/80 sm:hover:border-primary sm:hover:text-primary rounded-full transition-all text-xs font-semibold uppercase tracking-[0.14em] cursor-pointer text-foreground flex items-center gap-1.5"
									aria-label="Profile Menu"
								>
									<User className="w-4.5 h-4.5 sm:w-3.5 sm:h-3.5" />
